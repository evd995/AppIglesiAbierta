    ...
    this.sendCode = function(phoneNumber, cb, ce){
        ...
        */
        ...
        if (!ionic.Platform.isIOS()){
            ...
            return window.FirebasePlugin.verifyPhoneNumber(phoneNumber, 1200000)
...
im
    ...
    this.manageSignInCode = function(inputCode, verificationId){
        ...
        if (!ionic.Platform.isIOS()){
            ...
            var credential = firebase.auth.PhoneAuthProvider.credential(thiz.authDataConfirmation, inputCode);
